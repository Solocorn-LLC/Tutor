...
describe('resolveImageUrlsInHtml', () => {
  it('rewrites img src to by-key proxy when data-file-key is present', () => {
    const html =
      '<p><img src="https://storage.googleapis.com/bucket/documents/u/x.png?sig=abc" data-file-key="documents/u/x.png" alt="x"></p>'
  ...
  it('recovers the key from a path-style GCS URL when data-file-key is absent', () => {
    const html =
      '<p><img src="https://storage.googleapis.com/bucket/documents/u/y.png?sig=abc" alt="y"></p>'
    const out = resolveImageUrlsInHtml(html)
  ...
  it('returns the original HTML when document is undefined', () => {
    ...
    const html =
      '<p><img src="https://storage.googleapis.com/bucket/documents/u/z.png" data-file-key="documents/u/z.png"></p>'
