 ...
 * The schedule itself launches the session; tutor login is tracked separately
 * via tutorJoinedAt for payment gating. This scan is a safety net for sessions
 * where no route handler has promoted the status yet.
 */
