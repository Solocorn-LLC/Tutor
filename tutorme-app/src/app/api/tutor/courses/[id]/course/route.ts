...
export const PUT = withCsrf(
  withAuth(
    async (req: NextRequest, session, context) => {
      ...
      console.log('[CourseBuilder PUT] received lessons count:', Array.isArray(lessons) ? lessons.length : 'not array')
      if (Array.isArray(lessons)) {
        console.log('[CourseBuilder PUT] received lesson ids:', lessons.map((l: any) => l.id))
        console.log('[CourseBuilder PUT] received task counts:', lessons.map((l: any) => (l.tasks || []).length))
        console.log('[CourseBuilder PUT] received homework counts:', lessons.map((l: any) => (l.homework || []).length))
      }
