    ...
    <div className="flex h-full min-h-full flex-col bg-white px-3 pb-0 lg:px-4">
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden pb-4">
        <div className="flex h-full flex-col overflow-hidden rounded-2xl border border-[#E5E7EB] bg-white shadow-[0_18px_60px_rgba(0,0,0,0.16)] ring-1 ring-black/5">
          {/* Panel header — creates visible top edge for floating effect */}
          <div className="flex flex-shrink-0 items-center justify-between border-b border-[#E5E7EB] bg-slate-50 px-4 py-2.5 sm:px-6">
            <h3 className="text-sm font-semibold text-slate-700">Find Tutors</h3>
            <span className="text-xs text-slate-400">{tutors.length} available</span>
          </div>
          {/* Filters */}
