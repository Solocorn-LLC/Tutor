...
function TutorInsightsPageInner() {
  ...
  const handleSave = useCallback(
    async (lessons: any[], options?: any) => {
      console.log('[Insights handleSave] received lessons count:', lessons.length, 'isAutoSave:', options?.isAutoSave, 'isPublishedVariant:', isPublishedVariant)
      console.log('[Insights handleSave] lesson ids:', lessons.map((l: any) => l.id))
      console.log('[Insights handleSave] task counts per lesson:', lessons.map((l: any) => (l.tasks || []).length))
      console.log('[Insights handleSave] homework counts per lesson:', lessons.map((l: any) => (l.homework || []).length))
