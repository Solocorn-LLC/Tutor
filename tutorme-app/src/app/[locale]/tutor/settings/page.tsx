  ...
  return (
    <div className="flex h-full min-h-full flex-col bg-white px-3 pb-0 pt-2 lg:px-4 lg:pt-0">
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden pb-0.5">
        <Card className="flex h-full flex-col overflow-hidden rounded-[16px] border border-[#E5E7EB] bg-slate-50 p-5 ring-1 ring-black/5">
                    ...
                    <div className="space-y-6 p-6">
                      <div className="grid gap-4 md:grid-cols-3">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="h-10 rounded-md border bg-white px-3 py-2 text-sm">
                            $15
                          </div>
                        </div>
                        <div className="space-y-2">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-sm text-gray-500">
                              Text message reminders for lessons
                            </p>
                          </div>
                          <Switch
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">
                              When a session starts, automatically broadcast your classroom view to
                              all students
                            </p>
                          </div>
                        </div>
