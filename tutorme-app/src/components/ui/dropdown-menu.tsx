...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-default select-none items-center gap-3.5 rounded-lg px-3.5 py-2.5 text-sm font-semibold text-white/[0.96] outline-none transition-all hover:bg-white/20 focus:bg-white/20 focus:outline-none focus:ring-0 focus-visible:bg-white/20 focus-visible:outline-none focus-visible:ring-0 active:scale-[0.98] data-[disabled]:pointer-events-none data-[highlighted]:bg-white/20 data-[disabled]:opacity-50 data-[highlighted]:outline-none data-[highlighted]:ring-0',
      inset && 'pl-8',
      className
    )}
    {...props}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-3.5 py-2.5 text-sm font-semibold text-white/[0.7]',
      inset && 'pl-8',
      className
    )}
    {...props}
