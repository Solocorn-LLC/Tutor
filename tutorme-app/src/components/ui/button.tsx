    ...
    variants: {
      variant: {
        ...
        'modal-primary': [
          ...
          'h-10 px-6',
          'shadow-sm',
          'hover:border-blue-700 hover:bg-white hover:text-blue-700',
          'active:bg-blue-900',
          'disabled:opacity-50',
        ],
        ...
        'modal-secondary': [
          ...
          'rounded-md',
          'h-10 px-6',
          'hover:border-black hover:bg-white hover:text-gray-900',
          'active:bg-gray-100',
          'disabled:opacity-50',
        ],
        ...
        'modal-primary-dark': [
          ...
          'h-10 px-6',
          'shadow-elevation-2',
          'hover:border-[#194BB9] hover:bg-white hover:text-[#194BB9]',
          'active:bg-white/90',
